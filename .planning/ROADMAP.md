...
- [x] 03-01-PLAN.md — Foundation: scaffold Next 14 static-export frontend (locked stack + palette), apiUrl helper (D-01), backend types + formatters, backend CORS middleware (D-02) (UI-11, UI-12)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 03-02-PLAN.md — Live data + watchlist: useSse hook, split PriceContext/PortfolioContext (D-04/D-05), AppShell + Header live total (D-06) + ConnectionDot (D-03), WatchlistPanel/Row/Flash/Sparkline, EmptyState + Toast (UI-01, UI-02, UI-09, UI-10, UI-12)
